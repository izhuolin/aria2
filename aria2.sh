...
Download_aria2() {
    ...
    while [[ $(which aria2c) ]]; do
		...
		GithubDown_URL="https://github.com/P3TERX/Aria2-Pro-Core/releases/download/${aria2_new_ver}/aria2-${aria2_new_ver%_*}-static-linux-${ARCH}.tar.gz"
    DOWNLOAD_URL="https://gh.301.ee/https://github.com/P3TERX/Aria2-Pro-Core/releases/download/${aria2_new_ver}/aria2-${aria2_new_ver%_*}-static-linux-${ARCH}.tar.gz"
    {
        wget -t2 -T3 -O- "${DOWNLOAD_URL}" ||
            wget -t2 -T3 -O- "https://ghp.p3terx.com/${GithubDown_URL}"
    } | tar -zx
...
Service_aria2() {
    if [[ ${release} = "centos" ]]; then
        wget -N -t2 -T3 "https://github.guanmengkai.bf/https://raw.githubusercontent.com/P3TERX/aria2.sh/master/service/aria2_centos" -O /etc/init.d/aria2 ||
        ...
        wget -N -t2 -T3 "https://github.guanmengkai.bf/https://raw.githubusercontent.com/P3TERX/aria2.sh/master/service/aria2_debian" -O /etc/init.d/aria2 ||
...
Update_bt_tracker() {
    ...
    check_pid
    [[ -z $PID ]] && {
        bash <(wget -qO- https://ghp.p3terx.com/https://raw.githubusercontent.com/izhuolin/aria2/master/tracker.sh) ${aria2_conf}
    } || {
        bash <(wget -qO- https://gh.301.ee/https://raw.githubusercontent.com/izhuolin/aria2/master/tracker.sh) ${aria2_conf} 
    } || {
        bash <(wget -qO- https://github.guanmengkai.bf/https://raw.githubusercontent.com/izhuolin/aria2/master/tracker.sh) ${aria2_conf} RPC
    }
}
Update_aria2() {
    check_installed_status
